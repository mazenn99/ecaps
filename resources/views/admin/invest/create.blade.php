                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form id="quickForm" action="{{route('invest.store')}}" method="POST">
                                    @csrf
                                    <div class="card-body">
...
{{--                                            <input type="text" name="percentage" class="form-control" id="exampleInputEmail1" placeholder="Enter percentage">--}}
{{--                                        </div>--}}
{{--                                        <div class="form-group">--}}
{{--                                            <label for="exampleInputEmail1">shares number</label>--}}
{{--                                            <input type="text" name="shares" class="form-control" id="exampleInputEmail1" placeholder="Enter percentage">--}}
{{--                                        </div>--}}
                                        <div class="form-group">
