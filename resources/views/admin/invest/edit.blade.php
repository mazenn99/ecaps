                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Invest create</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form id="quickForm" action="{{route('invest.update' , $user->id)}}" method="POST">
                                    @csrf
                                    @method("PUT")
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="username" value="{{$user->username}}" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                                        </div>
                                        <div class="form-group">
...
{{--                                            <input type="text" name="percentage" value="{{$user->percentage}}" class="form-control" id="exampleInputEmail1" placeholder="Enter percentage">--}}
{{--                                        </div>--}}
{{--                                        <div class="form-group">--}}
{{--                                            <label for="exampleInputEmail1">shares number</label>--}}
{{--                                            <input type="text" name="shares" value="{{$user->shares_number}}" class="form-control" id="exampleInputEmail1" placeholder="Enter percentage">--}}
{{--                                        </div>--}}
                                        <div class="form-group">
